...
def show_visualization():
    ...
    try:
        ...
        viz_type = st.radio(
            "Visualization Type",
            ["Coin History Plot", "Portfolio Charts"],
            horizontal=True
        )
    ...
    try:
        ...
        if not df.empty and 'symbol' in df.columns:
            ...
            with col2:
                ...
                st.selectbox("Time period:", list(period_options.keys()),
    ...
    try:
        ...
        if 'id' in df.columns:
            ...
            if 'buy_price_cad' in timeline_data.columns and 'amount' in timeline_data.columns:
                ...
                ax_timeline.plot(range(len(timeline_data)), timeline_data['investment_value'].cumsum(),
        ...
        if 'symbol' in df.columns:
            for symbol in df['symbol'].unique():
                ...
                total_investment = (symbol_data['buy_price_cad'] * symbol_data['amount']).sum() if 'buy_price_cad' in symbol_data.columns else 0
